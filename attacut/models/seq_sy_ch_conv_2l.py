...
class Model(BaseModel):
    ...
    def __init__(self, data_config, model_config="embc:16|embs:8|conv:16|l1:16|do:0.0|oc:BI"):
        ...
        self.conv2 = ConvolutionLayer(conv_filters, conv_filters, 3)
        self.conv3 = ConvolutionLayer(conv_filters, conv_filters, 3)
    ...
    def forward(self, inputs):
        ...
        conv3 = self.dropout(self.conv3(conv2)).permute(0, 2, 1)

        out = F.relu(self.linear1(conv3))
